...
headmõtted();
echo "<br>";
 //funktiooni esilekutsumine
 echo tervita();
 echo "<br>";
 echo tervita("Keiti", "Kõmmus");
 echo "<br>";
 echo tervita("Maasika", "Mari");
 echo "<br>";
 uudiskiri();
...
?>
      ...
      <h1>Massiivid</h1>  
<?php
    $nimed = array("Mari","Kati", "Mai","Kai","Juuli","Maail");
    sort($nimed);
    //print_r($nimed);
...
echo "Toyotasid on: ".$toyota."<br>Audisid on: ".$audi;
echo "<br>------------<br>";
...
echo "Lühemad, kui 17 tähemärki VIN koode on: ".$sort_vin;
echo "<br>------------<br>";
